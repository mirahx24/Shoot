...
#pragma once
// System.Collections.Generic.RBTree/Node[]
struct NodeU5BU5D_t2895230743  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) Node_t2433570 * m_Items[1];

public:
	inline Node_t2433570 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Node_t2433570 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Node_t2433570 * value)
	{
		m_Items[index] = value;
